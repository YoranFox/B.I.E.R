        ...
        for solution in possible_solutions:
            ...
            if "id" not in solution:
                cv2.rectangle(
                    frame,
                    (x_frame, y_frame),
                    (x_frame + w_frame, y_frame + h_frame),
                    (36, 12, 255),
                    3,
                )
        ...
        for solution in solutions:
            ...
            if solution.get("type") == "predicted":
                ...
                cv2.putText(
                    frame,
                    "x: "
                    + str(solution.get("location_x"))
                    + "    y: "
                    + str(solution.get("location_y")),
                    (x_frame, int(math.ceil(y_frame - (w_frame * 0.15 + 10)))),
                    font,
                    0.005 * w_frame + 0.3,
                    fontColor,
                    lineType,
                ...
                cv2.putText(
                    ...
                    + str(solution.get("camera_angle_correction")),
                    (x_frame, int(math.ceil(y_frame - (w_frame * 0.25 + 20)))),
                    font,
                    0.005 * w_frame + 0.3,
                    fontColor,
                    lineType,
                ...
                cv2.putText(
                    frame,
                    "distance: " + str(solution.get("distance")),
                    (x_frame, int(math.ceil(y_frame - (w_frame * 0.35 + 30)))),
                    font,
                    0.005 * w_frame + 0.3,
                    fontColor,
                    lineType,
...
def draw_layout(layout, solutions):
    ...
    if len(solutions) > 0:
        ...
        robot_location_rounded = (
            int(math.ceil(robot_location[0])),
            int(math.ceil(robot_location[1])),
        )
        ...
        for solution in solutions:
            cv2.line(
                layout,
                robot_location_rounded,
                (solution.get("location_x"), solution.get("location_y")),
                (0, 0, 255),
            )
